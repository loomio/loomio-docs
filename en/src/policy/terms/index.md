...
We may update these Terms of Service in the future. You can track changes [on GitHub](https://github.com/loomio/loomio-docs/tree/main/en/src/policy). Typically these changes have been to clarify some of these terms by linking to an expanded related policy. Whenever we make a significant change to our policies, we will also announce them on our [blog](https://blog.loomio.com).
