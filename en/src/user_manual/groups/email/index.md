...
![location of the email address on the group page](../../assets/email_email_button.png)
...
![Location of the approve and reject buttons for an unrecognised email](../../assets/email_unreleased_emails.png)
